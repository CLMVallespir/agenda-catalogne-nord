...
// Categoria en català (la llista canònica del §4 de CLAUDE.md) i traducció
// francesa per al selector.
var CATEGORIES = [
  ...
  { ca: 'Esports', fr: 'Sports' },
  { ca: 'Vida associativa', fr: 'Vie associative' }
];
...
var CATEGORIA_ICONES = {
  ...
  'Esports': '<svg viewBox="0 0 24 24" focusable="false"><path d="M8 3l3 5.5M16 3l-3 5.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><circle cx="12" cy="14.5" r="5.5" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="14.5" r="1.9" fill="currentColor"/></svg>',
  'Vida associativa': '<svg viewBox="0 0 24 24" focusable="false"><circle cx="12" cy="12" r="4.2" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="3.8" r="1.8" fill="currentColor"/><circle cx="20.2" cy="12" r="1.8" fill="currentColor"/><circle cx="12" cy="20.2" r="1.8" fill="currentColor"/><circle cx="3.8" cy="12" r="1.8" fill="currentColor"/></svg>'
};
